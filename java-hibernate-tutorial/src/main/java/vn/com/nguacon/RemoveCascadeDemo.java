...
import vn.com.nguacon.model.removecascade.Country;
import vn.com.nguacon.model.removecascade.State;
import vn.com.nguacon.repository.HibernateDaoSupport;

public class RemoveCascadeDemo {
	public static void main(String[] args) {
		...
		/*
		 * Cascade.REMOVE: câu lệnh insert lớp có khoá ngoại thì lớp là khoá
		 * ngoại phải được insert vào database từ trước 
		 * Delete country -- state ROMOVED
