...
import vn.com.nguacon.model.detachcascade.Country;
import vn.com.nguacon.model.detachcascade.State;
import vn.com.nguacon.repository.HibernateDaoSupport;


public class DetachCascadeDemo {
	public static void main(String[] args) {
		...
		/*
		 * Cascade.DETACH: tuong tu PERSIST
		 */
	}
}
