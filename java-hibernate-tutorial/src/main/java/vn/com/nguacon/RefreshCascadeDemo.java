...
import vn.com.nguacon.model.refreshcascade.Country;
import vn.com.nguacon.model.refreshcascade.State;
import vn.com.nguacon.repository.HibernateDaoSupport;

public class RefreshCascadeDemo {
	public static void main(String[] args) {
		...
		/*
		 * Cascade.REFRESH: tuong tu PERSIST 
		 */
	}
}
